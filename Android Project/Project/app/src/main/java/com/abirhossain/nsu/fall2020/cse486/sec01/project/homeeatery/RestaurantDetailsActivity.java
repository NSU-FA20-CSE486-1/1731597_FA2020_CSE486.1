...
public class RestaurantDetailsActivity extends AppCompatActivity {
    ...
    private ImageView shopImage,backBtnShopDetails,callRestaurant,filterFoodBtn;
    private TextView  ShopNameTV,shopStatusTV,feeTV,ShopEmailTV,ShopPhoneTV,ShopAddressTV,
            filteredFoodTV;
    private EditText searchFoodsET;
    private RecyclerView foodsShowToClientRL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodsShowToClientRL = findViewById(R.id.foodsShowToClientRL);
    }
}